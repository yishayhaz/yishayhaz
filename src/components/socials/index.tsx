...
export const Socials = component$(() => {
  return (
    <div class={styles.socials}>
      <a href="https://github.com/yishayhaz" target="_blank">
        <svg
          stroke="currentColor"
          fill="currentColor"
          stroke-width="0"
      ...
      <a
        href="https://www.linkedin.com/in/yishay-hazan-85a102214/"
        target="_blank"
      >
        <svg
          stroke="currentColor"
      ...
      <a href="https://twitter.com/yishayhaz" target="_blank">
        <svg
          stroke="currentColor"
          fill="currentColor"
          stroke-width="0"
      ...
      <a href="mailto:yishay11013@gmail.com">
        <svg
          stroke="currentColor"
          fill="currentColor"
          stroke-width="0"
      ...
      <a href="https://www.npmjs.com/~yishayhaz" target="_blank">
        <svg
          stroke="currentColor"
          fill="currentColor"
          stroke-width="0"
      ...
      <a
        href="https://medium.com/@yishayhaz"
        target="_blank"
        aria-label="medium"
      >
        <svg
